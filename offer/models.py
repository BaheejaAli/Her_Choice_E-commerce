...
class Offer(models.Model):
    ...
    product = models.ManyToManyField(Product, blank=True,related_name='product_offers')
    category = models.ManyToManyField(Category, blank=True,related_name='category_offers')
